...
builds:
  - ldflags:
      - -w -s
      - -X github.com/purpose168/edgevpn/internal.Version={{.Tag}}
      - -X github.com/purpose168/edgevpn/internal.Commit={{.Commit}}
    env:
      - CGO_ENABLED=0
    goos:
      - linux
...
wget https://github.com/purpose168/edgevpn/releases/download/v1.0.0/edgevpn-v1.0.0-linux-amd64

# 或使用 curl
curl -LO https://github.com/purpose168/edgevpn/releases/download/v1.0.0/edgevpn-v1.0.0-linux-amd64
...
services:
  edgevpn:
    image: quay.io/purpose168/edgevpn:latest
    pull_policy: always
    ...
    steps:
      ...
      - name: Build and push
        ...
        with:
          context: .
          push: true
          tags: quay.io/purpose168/edgevpn:latest
```
...
# 配置
VERSION="v1.0.0"
BINARY_URL="https://github.com/purpose168/edgevpn/releases/download/${VERSION}/edgevpn-${VERSION}-linux-amd64"
...
# 3. 下载新版本
wget https://github.com/purpose168/edgevpn/releases/download/v1.1.0/edgevpn-v1.1.0-linux-amd64
