...
flowchart TD
    ...
    subgraph DEV["🔧 开发环境"]
        DEVELOP["🔨 develop<br/>开发分支"]
    end

    subgraph WORK["💻 工作分支"]
        direction LR
        FEATURE["✨ feature/*<br/>功能分支"]
        HOTFIX["🐛 hotfix/*<br/>修复分支"]
        RELEASE["🚀 release/*<br/>发布分支"]
    end

    FEATURE -->|"功能完成"| DEVELOP
    HOTFIX -->|"紧急修复"| MAIN
    HOTFIX -->|"修复合并"| DEVELOP
...
# 1. 访问 https://github.com/purpose168/edgevpn/releases/new
# 2. 选择标签 v1.0.0
# 3. 填写发布说明
# 4. 上传构建产物
# 5. 发布
...
[Unreleased]: https://github.com/purpose168/edgevpn/compare/v1.0.0...HEAD
[1.0.0]: https://github.com/purpose168/edgevpn/releases/tag/v1.0.0
```
